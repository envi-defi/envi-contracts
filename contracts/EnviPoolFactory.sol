...
// File: contracts/EnviPoolInitializable.sol

pragma solidity 0.6.12;

contract EnviPoolInitializable is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // The address of the smart chef factory
    address public ENVI_POOL_FACTORY;
    ...
    function initialize(
        ...
        require(msg.sender == ENVI_POOL_FACTORY, "Not factory");
...
// File: contracts/EnviPoolFactory.sol

pragma solidity 0.6.12;

contract EnviPoolFactory is Ownable {
    event NewEnviPoolContract(address indexed smartChef);
    ...
    function deployPool(
        ...
        bytes memory bytecode = type(EnviPoolInitializable).creationCode;
        bytes32 salt =
            keccak256(
        ...
        EnviPoolInitializable(smartChefAddress).initialize(
            _stakedToken,
            _rewardToken,
            _rewardPerBlock,
            _startBlock,
        ...
        emit NewEnviPoolContract(smartChefAddress);
    }
}
